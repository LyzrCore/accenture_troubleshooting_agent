...
from knowledge_graph import get_latest_data_from_graph
...
def generate_knowledge_graph_analysis(session_id, vin_number, issue_desc):
    latest_telemetry, machine_history = get_latest_data_from_graph(vin_number)

    input_text = (
        "Latest Telemetry Data: "
        + str(latest_telemetry)
        + "\nMachine History: "
        + str(machine_history)
        + "\nIssue Description: "
        + str(issue_desc)
    ...
    if kg_analysis:
        ...
        return latest_telemetry, machine_history, final_output
    else:
        return "Error: Unable to fetch from Knowledge Graph"
    # return (
    #     {
    #         "type": "telemetry",
    #         "engine_status": "Off",
    ...
    #         "machine_info": {
    #             "type": "machine",
    #             "machine_number": 89420010,
    #             "install_date": "23-12-2020",
    #         },
    #     },
